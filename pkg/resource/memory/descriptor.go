...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/Memory"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("memories")
