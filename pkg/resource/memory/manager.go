...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=memories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=memories/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"ACTIVE", "FAILED"}
