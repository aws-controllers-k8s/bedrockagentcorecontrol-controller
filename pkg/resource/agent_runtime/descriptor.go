...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/AgentRuntime"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("agentruntimes")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AgentRuntime{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AgentRuntime),
	}
}
