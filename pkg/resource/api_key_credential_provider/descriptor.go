...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/APIKeyCredentialProvider"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("apikeycredentialproviders")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.APIKeyCredentialProvider{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.APIKeyCredentialProvider),
	}
}
