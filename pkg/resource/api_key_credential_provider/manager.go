...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=apikeycredentialproviders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=apikeycredentialproviders/status,verbs=get;update;patch
