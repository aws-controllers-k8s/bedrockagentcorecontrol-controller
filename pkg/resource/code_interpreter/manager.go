...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=codeinterpreters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=codeinterpreters/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"READY", "CREATE_FAILED"}
