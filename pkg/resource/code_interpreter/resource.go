...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.CodeInterpreterID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["codeInterpreterID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: codeInterpreterID"))
	}
	r.ko.Status.CodeInterpreterID = &primaryKey
