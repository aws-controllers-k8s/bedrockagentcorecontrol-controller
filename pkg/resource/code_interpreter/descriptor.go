...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/CodeInterpreter"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("codeinterpreters")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CodeInterpreter{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CodeInterpreter),
	}
}
