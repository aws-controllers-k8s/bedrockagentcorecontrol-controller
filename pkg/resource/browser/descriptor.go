...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/Browser"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("browsers")
