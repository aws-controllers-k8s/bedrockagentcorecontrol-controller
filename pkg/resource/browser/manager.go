...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=browsers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=browsers/status,verbs=get;update;patch
