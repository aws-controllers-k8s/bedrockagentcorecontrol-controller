...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=policyengines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=policyengines/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"ACTIVE", "CREATE_FAILED", "UPDATE_FAILED", "DELETE_FAILED"}
