...
func (rm *resourceManager) sdkFind(
	...
	var resp *svcsdk.GetPolicyEngineOutput
	resp, err = rm.sdkapi.GetPolicyEngine(ctx, input)
	rm.metrics.RecordAPICall("READ_ONE", "GetPolicyEngine", err)
	if err != nil {
	...
	if resp.PolicyEngineArn != nil {
		arn := ackv1alpha1.AWSResourceName(*resp.PolicyEngineArn)
		ko.Status.ACKResourceMetadata.ARN = &arn
	}
	if resp.PolicyEngineId != nil {
		ko.Status.ID = resp.PolicyEngineId
	} else {
		ko.Status.ID = nil
	}
	if resp.Status != "" {
...
func (rm *resourceManager) newDescribeRequestPayload(
	r *resource,
) (*svcsdk.GetPolicyEngineInput, error) {
	res := &svcsdk.GetPolicyEngineInput{}

	if r.ko.Status.ID != nil {
		res.PolicyEngineId = r.ko.Status.ID
	}
...
func (rm *resourceManager) sdkCreate(
	...
	var resp *svcsdk.CreatePolicyEngineOutput
	_ = resp
	resp, err = rm.sdkapi.CreatePolicyEngine(ctx, input)
	rm.metrics.RecordAPICall("CREATE", "CreatePolicyEngine", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.CreatePolicyEngineInput, error) {
	res := &svcsdk.CreatePolicyEngineInput{}
...
func (rm *resourceManager) sdkUpdate(
	...
	var resp *svcsdk.UpdatePolicyEngineOutput
	_ = resp
	resp, err = rm.sdkapi.UpdatePolicyEngine(ctx, input)
	rm.metrics.RecordAPICall("UPDATE", "UpdatePolicyEngine", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) newUpdateRequestPayload(
	...
	r *resource,
	delta *ackcompare.Delta,
) (*svcsdk.UpdatePolicyEngineInput, error) {
	res := &svcsdk.UpdatePolicyEngineInput{}
...
func (rm *resourceManager) sdkDelete(
	...
	var resp *svcsdk.DeletePolicyEngineOutput
	_ = resp
	resp, err = rm.sdkapi.DeletePolicyEngine(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DeletePolicyEngine", err)
	return nil, err
}
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeletePolicyEngineInput, error) {
	res := &svcsdk.DeletePolicyEngineInput{}
