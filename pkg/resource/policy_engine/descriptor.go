...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/PolicyEngine"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("policyengines")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.PolicyEngine{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PolicyEngine),
	}
}
