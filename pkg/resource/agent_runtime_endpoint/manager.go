...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=agentruntimeendpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=agentruntimeendpoints/status,verbs=get;update;patch
