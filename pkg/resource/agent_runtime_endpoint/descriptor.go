...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/AgentRuntimeEndpoint"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("agentruntimeendpoints")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AgentRuntimeEndpoint{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AgentRuntimeEndpoint),
	}
}
