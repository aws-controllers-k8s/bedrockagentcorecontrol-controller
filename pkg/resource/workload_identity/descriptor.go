...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/WorkloadIdentity"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("workloadidentities")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.WorkloadIdentity{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.WorkloadIdentity),
	}
}
