...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=workloadidentities,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=workloadidentities/status,verbs=get;update;patch
