...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=harnessendpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=harnessendpoints/status,verbs=get;update;patch
