...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/HarnessEndpoint"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("harnessendpoints")
	GroupKind            = metav1.GroupKind{
		Group: "bedrockagentcorecontrol.services.k8s.aws",
		Kind:  "HarnessEndpoint",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.HarnessEndpoint{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.HarnessEndpoint),
	}
}
