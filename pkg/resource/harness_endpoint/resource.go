...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	f1, f1ok := identifier.AdditionalKeys["harnessID"]
	if f1ok {
		r.ko.Spec.HarnessID = aws.String(f1)
	}
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f1, ok := fields["harnessID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: harnessID"))
	}
	r.ko.Spec.HarnessID = &f1
