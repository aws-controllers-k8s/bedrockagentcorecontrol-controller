...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/BrowserProfile"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("browserprofiles")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.BrowserProfile{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.BrowserProfile),
	}
}
