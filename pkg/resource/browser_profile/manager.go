...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=browserprofiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=browserprofiles/status,verbs=get;update;patch
