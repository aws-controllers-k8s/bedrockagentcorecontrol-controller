...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=policies/status,verbs=get;update;patch
