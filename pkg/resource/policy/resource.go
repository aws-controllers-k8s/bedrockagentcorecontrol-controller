...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	f0, f0ok := identifier.AdditionalKeys["policyEngineID"]
	if f0ok {
		r.ko.Spec.PolicyEngineID = aws.String(f0)
	}
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f0, ok := fields["policyEngineID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: policyEngineID"))
	}
	r.ko.Spec.PolicyEngineID = &f0
