...
func (in *ConnectorConfiguration) DeepCopyInto(out *ConnectorConfiguration) {
	*out = *in
	...
	if in.ParameterOverrides != nil {
		...
		*out = make([]*ConnectorParameterOverride, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConnectorSource) DeepCopyInto(out *ConnectorSource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectorSource.
func (in *ConnectorSource) DeepCopy() *ConnectorSource {
	if in == nil {
		return nil
	}
	out := new(ConnectorSource)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConnectorTargetConfiguration) DeepCopyInto(out *ConnectorTargetConfiguration) {
	*out = *in
	if in.Configurations != nil {
		in, out := &in.Configurations, &out.Configurations
		*out = make([]*ConnectorConfiguration, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ConnectorConfiguration)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectorTargetConfiguration.
func (in *ConnectorTargetConfiguration) DeepCopy() *ConnectorTargetConfiguration {
	if in == nil {
		return nil
	}
	out := new(ConnectorTargetConfiguration)
	in.DeepCopyInto(out)
	return out
}
